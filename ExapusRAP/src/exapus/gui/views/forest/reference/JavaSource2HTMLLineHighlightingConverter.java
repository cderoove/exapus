...
public class JavaSource2HTMLLineHighlightingConverter extends AbstractJavaSourceConverter {
	...
	private JavaSourceLineHighlight currentSourceLineHighlight;
	
	private JavaSourceLineHighlights sourceHighlights;


	public JavaSource2HTMLLineHighlightingConverter() {
	...
	private void writeSourceCode(JavaSource source, JavaSourceConversionOptions options, BufferedWriter writer)
		...
		while (iterator.hasNext()) {
			...
			currentSourceLineHighlight = sourceHighlights.getHighlightForLine(currentLineNumber);
	...
	private void writeLineNumber(JavaSourceConversionOptions options, BufferedWriter writer, int lineNo)
	  ...
	  private void toHTML(JavaSourceStyleTable styleTable, JavaSourceRun run, BufferedWriter writer)
		    ...
		    writeStyleStart(writer, style, currentSourceLineHighlight != null ? currentSourceLineHighlight.color : null);
	...
	public JavaSourceLineHighlights getSourceHighlights() {
		return sourceHighlights;
	}

	public void setSourceHighlights(JavaSourceLineHighlights sourceHighlights) {
